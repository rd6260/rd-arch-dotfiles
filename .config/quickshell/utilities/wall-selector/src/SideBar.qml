...
Rectangle {
  ...
  radius: 8
  width: expanded ? shortcutColumn.width + 32 : !hideHelp ? collapsedColumn.width + 32 : 0
  height: expanded ? shortcutColumn.height + 32 : !hideHelp ? collapsedColumn.height + 32 : 0
